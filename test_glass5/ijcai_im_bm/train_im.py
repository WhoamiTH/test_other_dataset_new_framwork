...
for i in range(train_time):
    positive_data_index, negative_data_index, select_negative_data_index = handle_data.generate_batch_data_im(positive_index_list, negative_index_list, informative_minority_list, positive_length, negative_length, informative_minority_length, batch_size)
