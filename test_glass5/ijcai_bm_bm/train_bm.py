...
for i in range(train_time):
    positive_data_index, negative_data_index, select_negative_data_index = handle_data.generate_batch_data_bm(positive_index_list, negative_index_list, border_majority_list, positive_length, negative_length, border_majority_length, batch_size)
