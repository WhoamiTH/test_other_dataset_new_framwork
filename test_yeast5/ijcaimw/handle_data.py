...
def generate_batch_data(positive_data, negative_data, batch_size):
    ...
    positive_data_index = np.random.choice(positive_length, current_batch_size, replace=False)
    negative_data_index = np.random.choice(negative_length, times*current_batch_size, replace=False)

    # print(negative_length)
    # print(positive_length)
    # print(negative_length/positive_length)
    # print(times)
    # print(current_batch_size)
    # print(positive_data_index)
    # print(negative_data_index)
