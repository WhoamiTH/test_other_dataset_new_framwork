...
border_majority, informative_minority = sampling_model.getTrainingSample(train_data, train_label)

print(border_majority)
print(informative_minority)
