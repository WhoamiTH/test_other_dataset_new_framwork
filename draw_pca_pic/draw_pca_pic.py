...
ax01.scatter(pca_pos_train_data[:, 0], pca_pos_train_data[:, 1], color='r', label='pos')
ax01.scatter(pca_neg_train_data[:, 0], pca_neg_train_data[:, 1], color='b', label='neg')
ax01.set_title('original pca')
ax01.legend(loc=0)

ax02.scatter(kernel_pca_pos_train_data[:, 0], kernel_pca_pos_train_data[:, 1], color='r', label='pos')
ax02.scatter(kernel_pca_neg_train_data[:, 0], kernel_pca_neg_train_data[:, 1], color='b', label='neg')
...
ax11.scatter(pca_pos_concat_mirror_data[:, 0], pca_pos_concat_mirror_data[:, 1], color='r', label='pos')
ax11.scatter(pca_neg_concat_mirror_data[:, 0], pca_neg_concat_mirror_data[:, 1], color='b', label='neg')
ax11.set_title('concat mirror pca')
ax11.legend(loc=0)

ax12.scatter(kernel_pca_pos_concat_mirror_data[:, 0], kernel_pca_pos_concat_mirror_data[:, 1], color='r', label='pos')
ax12.scatter(kernel_pca_neg_concat_mirror_data[:, 0], kernel_pca_neg_concat_mirror_data[:, 1], color='b', label='neg')
...
ax21.scatter(pca_pos_concat_not_mirror_data[:, 0], pca_pos_concat_not_mirror_data[:, 1], color='r', label='pos')
ax21.scatter(pca_neg_concat_not_mirror_data[:, 0], pca_neg_concat_not_mirror_data[:, 1], color='b', label='neg')
...
ax31.scatter(pca_pos_minus_mirror_data[:, 0], pca_pos_minus_mirror_data[:, 1], color='r', label='pos')
ax31.scatter(pca_neg_minus_mirror_data[:, 0], pca_neg_minus_mirror_data[:, 1], color='b', label='neg')
ax31.set_title('minus mirror pca')
ax31.legend(loc=0)

ax32.scatter(kernel_pca_pos_minus_mirror_data[:, 0], kernel_pca_pos_minus_mirror_data[:, 1], color='r', label='pos')
ax32.scatter(kernel_pca_neg_minus_mirror_data[:, 0], kernel_pca_neg_minus_mirror_data[:, 1], color='b', label='neg')
...
ax41.scatter(pca_pos_minus_not_mirror_data[:, 0], pca_pos_minus_not_mirror_data[:, 1], color='r', label='pos')
ax41.scatter(pca_neg_minus_not_mirror_data[:, 0], pca_neg_minus_not_mirror_data[:, 1], color='b', label='neg')
ax41.set_title('minus not mirror pca')
ax41.legend(loc=0)

ax42.scatter(kernel_pca_pos_minus_not_mirror_data[:, 0], kernel_pca_pos_minus_not_mirror_data[:, 1], color='r', label='pos')
ax42.scatter(kernel_pca_neg_minus_not_mirror_data[:, 0], kernel_pca_neg_minus_not_mirror_data[:, 1], color='b', label='neg')
