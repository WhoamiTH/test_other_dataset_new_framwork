...
# ----------------------------------start processing-------------------------------------
print('{0}_{1}_draw_concat_mirror_pca\n'.format(dataset_name, dataset_index))
...
def plot_two_pca_fig(pca_data, kernel_pca_data, label, record_path, dataset_name, dataset_index):
    ...
    ax1.set_title('concat_mirror_pca')
    ax1.legend(loc=0)
    ...
    ax2.set_title('concat_mirror_kernel_pca')
    ax2.legend(loc=0)

    record_file_postfix = 'concat_mirror_data_pca'
...
plot_two_pca_fig(pca_concat_mirror_train_data, kernel_pca_concat_mirror_train_data, concat_mirror_train_label, record_path, dataset_name, dataset_index )
