...
def plot_two_pca_fig(pca_data, kernel_pca_data, label, record_path, dataset_name, dataset_index):
    ...
    ax1.set_title('minus_mirror_pca')
    ax1.legend(loc=0)
    ...
    ax2.set_title('original_kernel_pca')
    ax2.legend(loc=0)
...
plot_two_pca_fig(pca_minus_mirror_train_data, kernel_pca_minus_mirror_train_data, minus_mirror_train_label, record_path, dataset_name, dataset_index )
