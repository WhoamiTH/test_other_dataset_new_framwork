...
model_record_path = './test_{0}/model_LR_minus_not_mirror/record_{1}/'.format(dataset_name, record_index)


# ----------------------------------start processing-------------------------------------
print(file_name)

model_name = model_record_path + 'LR_minus_not_mirror_{0}.m'.format(dataset_index)
print(model_name)
