...
boundary_number = int(reference_minority_length/2)
...
current_test_data = handle_data.transform_data_to_test_form_data_bm_and_im(test_data, informative_minority_data)
