...
with open(train_record_name,'w') as train_file:
    ...
    record_name
    """
    train_file.write('python test.py train_file_name=../1_year_data/{8}_train.csv test_file_name=../1_year_data/{8}_validation.csv model_record_path=../1_year_result/model_{1}/ file_record_path=../1_year_result/record_{2}/ method_name={3} scaler_name=scaler_{4}.m model_name=model_{6} record_name=result_{7}.csv\n'.format(i, record_number, record_number, method_name, i, i, i, i, file_name_pre))
...
with open(test_record_name, 'w') as test_file:
    ...
    record_name
    """
    test_file.write('python test.py train_file_name=../1_year_data/{8}_train.csv test_file_name=../1_year_data/{8}_test.csv model_record_path=../1_year_result/model_{1}/ file_record_path=../1_year_result/record_{2}/ method_name={3} scaler_name=scaler_{4}.m model_name=model_{6} record_name=result_{7}.csv\n'.format(i, record_number, record_number, method_name, i, i, i, i, file_name_pre))
