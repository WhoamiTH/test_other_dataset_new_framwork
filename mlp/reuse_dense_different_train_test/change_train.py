...
# # one hidden layer ------------------------------------------------
# hidden1 = tf.layers.dense(inputs=x, units=10*single_input_size, use_bias=True, activation=tf.nn.relu)
...
# two hidden layer ------------------------------------------------
hidden1 = tf.layers.dense(inputs=x, units=5*transformed_input_size, use_bias=True, activation=tf.nn.sigmoid)
hidden2 = tf.layers.dense(inputs=hidden1, units=2*transformed_input_size, use_bias=True, activation=tf.nn.sigmoid)
hidden3 = tf.layers.dense(inputs=hidden2, units=2*single_input_size, use_bias=True, activation=tf.nn.sigmoid)
# y_pred = tf.layers.dense(inputs=hidden1, units=4, activation=tf.nn.sigmoid)
y_pred = tf.layers.dense(inputs=hidden3, units=num_class, activation=tf.nn.sigmoid)
