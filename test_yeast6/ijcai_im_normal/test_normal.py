...
current_test_data = handle_data.transform_data_to_test_form_data_normal(test_data, negative_data, test_time)

test_result = sess.run(y_pred, feed_dict={x: current_test_data})
test_length = test_data.shape[0]
test_pred_results = test_result[:, 0].reshape(test_length, -1)
...
# general_pred_results = test_pred_results
# print(general_pred_results)

general_vote_results = np.sum(test_pred_results, axis=1)

general_vote_results[general_vote_results<5] = 0
