...
model_record_path = './test_{0}/model_SVM_RBF_concat_mirror/record_{1}/'.format(dataset_name, record_index)


# ----------------------------------start processing-------------------------------------
print(train_file_name)

model_name = model_record_path + 'SVM_RBF_concat_mirror_{0}.m'.format(dataset_index)
print(model_name)
