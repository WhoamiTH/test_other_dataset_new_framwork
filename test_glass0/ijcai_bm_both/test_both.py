...
reference_minority_length = informative_minority_data.shape[0]
boundary_number = int((reference_majority_length+reference_minority_length)/2)
...
current_test_data = handle_data.transform_data_to_test_form_data_both(test_data, border_majority_data, informative_minority_data)
