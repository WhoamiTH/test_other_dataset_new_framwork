...
border_majority_index, informative_minority_index = sampling_model.getTrainingSample(train_data, label)
...
border_majority_label = handle_data.generate_transformed_label(border_majority_length, 0)
informative_minority_label = handle_data.generate_transformed_label(informative_minority_length, 1)

positive_index_list = [i for i in range(positive_length)]
negative_index_list = [i for i in range(negative_length)]
border_majority_list = [i for i in range(border_majority_length)]
informative_minority_list = [i for i in range(informative_minority_length)]
...
border_majority_dataset = tf.Variable(border_majority_data, trainable=False, dtype=tf.float32)
informative_minority_dataset = tf.Variable(informative_minority_data, trainable=False, dtype=tf.float32)
...
border_majority_labelset = tf.Variable(border_majority_label, trainable=False, dtype=tf.float32)
informative_minority_labelset = tf.Variable(informative_minority_label, trainable=False, dtype=tf.float32)
...
alldata1 = tf_generate_part_data(informative_minority_dataset, informative_minority_dataset, informative_minority_labelset, informative_minority_labelset, data_headindex1, data_tailindex1)
...
alldata2 = tf_generate_part_data(informative_minority_dataset, negative_dataset, informative_minority_labelset, negative_labelset, data_headindex2, data_tailindex2)
...
alldata3 = tf_generate_part_data(negative_dataset, informative_minority_dataset, negative_labelset, informative_minority_labelset, data_headindex3, data_tailindex3)
...
alldata4 = tf_generate_part_data(negative_dataset, border_majority_dataset, negative_labelset, border_majority_labelset, data_headindex4, data_tailindex4)
...
for i in range(train_time):
    positive_data_index, negative_data_index, select_negative_data_index = handle_data.generate_batch_data_both(positive_index_list, negative_index_list, border_majority_list, informative_minority_list, positive_length, negative_length, border_majority_length, informative_minority_length, batch_size)
