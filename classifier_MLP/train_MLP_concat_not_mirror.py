...
device_id = '1'
# ！！！！！！！！！！需要注意名字方法！！！！！！！
method_name = 'MLP_concat_not_mirror'
num_epochs = 5000
batch_size = 50
# ----------------------------------set parameters---------------------------------------
set_para()
...
# ！！！！！！！！！！需要注意名字方法！！！！！！！
model_record_path = './test_{0}/model_MLP_concat_not_mirror/record_{1}/'.format(dataset_name, record_index)
...
print('----------------------\n\n\n')
# ！！！！！！！！！！需要注意名字方法！！！！！！！
model_name = model_record_path + 'MLP_concat_not_mirror_{0}'.format(dataset_index)
print(model_name)
...
# ！！！！！！！！！！需要注意转换方法！！！！！！！
transformed_valid_data, transformed_valid_label = handleData_extend_not_mirror(valid_positive_data, valid_negative_data)
...
for epoch in range(num_epochs):
    ...
    # ！！！！！！！！！！需要注意转换方法！！！！！！！
    train_x, train_y = handleData_extend_not_mirror(batch_pos_data, batch_neg_data)
