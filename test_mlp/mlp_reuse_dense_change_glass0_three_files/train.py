...
# one hidden layer ------------------------------------------------
first_hidden1 = tf.layers.dense(inputs=x, units=5*single_input_size, use_bias=True, activation=tf.nn.relu, name='hidden1')
# first_hidden2 = tf.layers.dense(inputs=first_hidden1, units=single_input_size, use_bias=True, activation=tf.nn.relu, name='hidden2')
# first_hidden3 = tf.layers.dense(inputs=first_hidden2, units=1*single_input_size, use_bias=True, activation=tf.nn.relu, name='hidden3')
...
second_hidden1 = tf.layers.dense(inputs=x_2, units=5*single_input_size, use_bias=True, activation=tf.nn.relu, name='hidden1', reuse=True)
# second_hidden2 = tf.layers.dense(inputs=second_hidden1, units=single_input_size, use_bias=True, activation=tf.nn.relu, name='hidden2', reuse=True)
# second_hidden3 = tf.layers.dense(inputs=second_hidden2, units=1*single_input_size, use_bias=True, activation=tf.nn.relu, name='hidden3', reuse=True)
