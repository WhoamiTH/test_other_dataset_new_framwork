...
class datarecord:
    ...
    def calculate_average(self):
        self.af = self.calculate_average_value(self.af)
    ...
    def get_max(self):
        print(self.name, np.where(self.af==self.af.max()), self.af.max())
    ...
    def plotimage(self):
        ...
        plt.plot(x, self.af, label='F_score', color='b')
        ...
        plt.plot(x, average_af, label='average_F', c='g')
