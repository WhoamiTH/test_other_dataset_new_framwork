...
def next_batch(train_data, train_label, batch_size=50, pairsize=2, seq_length=1):
    x_examples = []
    y_examples = []
    t_examples = []
    ...
    y_examples = y_examples.reshape((-1,1))
...
#     select_index = random.sample(index_list, batch_size)

#     data = train_data[select_index]
#     label = train_label[select_index]
